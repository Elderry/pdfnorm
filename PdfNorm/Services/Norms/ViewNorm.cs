...
{
    public class ViewNorm : IPdfNorm
    {
        private readonly IssueReporter _issueReporter;
        private PdfConfig? _config;

        public ViewNorm(IssueReporter issueReporter)
        {
        ...
        private void NormalizeOpenAction(PdfCatalog catalog, PdfDocument pdfDoc, string pdfName, bool dryRun, List<FixRecord> fixRecords)
        {
            ...
            int targetPage = _config?.OpenToPage ?? 1; // Default to page 1
